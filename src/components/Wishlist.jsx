...
import { getToWishList, removeToWishList } from '../utilities/Data';
...
const Wishlist = () => {
    ...
    return (
        <div className='w-11/12 2xl:w-4/5 mx-auto mt-12 space-y-6'>
            <h2 className='text-3xl text-center font-bold'>WishList</h2>
            {
                    ...
                    <div key={wishList.product_id} className='flex flex-col md:flex-row justify-between items-center gap-4 bg-white px-5 py-5 rounded-2xl'>
                        ...
                        <div className='md:w-4/5 space-y-2 p-4 md:p-0'>
                            <div className='flex justify-between text-xl font-bold'>
                                ...
                                <TiDeleteOutline onClick={() => handleRemoveWishList(wishList.product_id)} className='text-red-400 text-3xl mt-7 justify-center mr-5 cursor-pointer' />
                            </div>
